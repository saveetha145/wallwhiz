...
import com.example.wallwhiz.PencilArtActivity;

public class WoodenFrameActivity extends AppCompatActivity {
    ...
    private void goToNextActivity() {
        ...
        Intent intent = new Intent(WoodenFrameActivity.this, PencilArtActivity.class);
