...
import com.example.wallwhiz.layout4;

class Layout3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layout3); // Ensure the layout file name matches your XML file
    ...
    private void navigateToNextActivity() {
        Intent intent = new Intent(Layout3Activity.this, layout4.class); // Replace 'NextActivity' with your actual next activity class
